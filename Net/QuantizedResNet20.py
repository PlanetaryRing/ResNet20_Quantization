...
class QuantizedResidual(nn.Module):
    ...
    def __init__(self, input_channels, num_channels, use_1x1conv=False, strides=1):
        super(QuantizedResidual,self).__init__()
        self.conv1 = QConv2d(
            nn.Conv2d(
...
class QuantizedResNet20(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv1 = nn.Sequential(
            QConv2d(nn.Conv2d(3, 16, kernel_size=3, padding=1, bias=False)),
            nn.BatchNorm2d(16),
...
def make_QuantizedResNet20(num_classes=10, **kargs):
    return QuantizedResNet20(QuantizedResidual, [3, 3, 3], num_classes=num_classes)
